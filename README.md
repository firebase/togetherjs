...
* <strong>Persistence</strong> - Sessions are automatically persisted, which allows for easy replay of sessions (cursor movements, chat history, etc) if required. Note this is not enabled by default, see comment on line 240 in channel.js to enable. 
